...
def list_chats(
    ...
    try:
        ...
        # Build base query — select the message columns only when we actually
        # JOIN the messages table; otherwise referencing messages.* with no
        # JOIN raises an SQL error and the whole call returns nothing.
